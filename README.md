...
​Data Persistence: Records are saved in a data.txt file, ensuring your data remains intact even after closing the program.
...
gcc <input_file> -o <output_filename> e.g. gcc searchstudent.c -o searchstudent
Run the executable:
./searchstudent
...
Core Concepts: File I/O, Structures, Pointers, and Control Flow
